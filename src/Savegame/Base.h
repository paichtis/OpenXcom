...
public:
	...
	/// Gets the amount of soldiers available for psi lab training.
	int countAvailableSoldiersForPsiTraining() const;
	...
	/// Gets the amount of soldiers available for training. 
	int countAvailableSoldiersForTraining() const;
